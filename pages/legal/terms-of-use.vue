<template>
  <div>
    ...
    <div class="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div class="prose">
        <p>
          We, at SolvMate, value the privacy of individuals who use our websites
          and related services (collectively, our “Services”). This privacy
          policy (the “Privacy Policy”) explains how we collect, use, and share
        ...
        <p>
          Registration Information. If you register to use our Services, sign up
          for notifications or updates, or participate in our surveys, we ask
          you for your name, email, geographic location and preferred
          language(s).
        </p>
        <p>
          Communications. If you contact us directly, we may receive additional
          information about you that you provide, such as your name, email
        ...
        <p>
          Careers. If you decide that you wish to apply for a job with us, you
          may submit your contact information and your resume online. We will
          ...
          LinkedIn and similar websites. If you do so, we will collect the
          information you make available to us on LinkedIn and similar websites.
        </p>

        <h3>B. Information We Collect When You Use Our Services.</h3>

        <p>
          Location Information. When you use our Services, we infer your general
        ...
        <p>
          ...
          manufacturer, device identifiers and similar information.
        </p>
        <p>
          Usage Information. To help us understand how you use our Services and
          to help us improve them, we automatically receive information about
          your interactions with our Services, like the pages or other content
          you view, the searches you conduct, and the dates and times of your
          visits.
        </p>
        <p>
          ...
          technologies. Our third-party partners, such as analytics and
          advertising partners, may use these technologies to collect
        ...
        <p>
          ...
          such as demographic data, from third parties such as data or marketing
        ...
        <ul>
          ...
          <li>
            ...
            request, respond to comments and questions;
          </li>
          <li>
            For advertising purposes, such as developing and providing
          ...
          <li>
            ...
            de-identified, non-personal information;
          </li>
          <li>
          ...
          <li>
            For compliance purposes, including enforcing our TOS or other legal
            rights, or as may be required by applicable laws and regulations or
        ...
        <p>
          ...
          with vendors and service providers retained in connection with the
          provision of our Services.
        </p>
        <p>
          Marketing. We do not rent, sell, or share information about you with
          non-affiliated companies for their direct marketing purposes, unless
          we have your permission.
        </p>
        <p>
          Analytics Partners. We use analytics services such as Google Analytics
          to collect and process certain analytics data. These services may also
          collect information about your use of other websites, apps, and online
          resources. You can learn more about Google’s practices by visiting
          https://www.google.com/policies/privacy/partners/. To help us
          understand how you use our Services and to help us improve them, we
          automatically receive information about your interactions with our
          Services, like the pages or other content you view, the searches you
          conduct, and the dates and times of your visits.
        </p>
        <p>
        ...
        <p>
          ...
          following any of these events will be governed by the provisions of
          this Privacy Policy in effect at the time the applicable information
          was collected.
        </p>
        <p>
        ...
        <p>
          Do Not Track. There is no accepted standard on how to respond to Do
        ...
        <p>
          ...
          storage of information can be entirely secure, we cannot guarantee the
        ...
        <p>
          ...
          directed to children under the age of 13. If you learn that a child
          has provided us with personal information in violation of this Privacy
          Policy, you can alert us at [email address].
        </p>
        <h2>Data collection</h2>
        <p>
          Our Services are hosted in the United States and If you choose to use Services from the European Union or other regions of the world with laws governing data collection and use that may differ from U.S. law, then please note that you are transferring your personal information outside of those regions to the United States for storage and processing. Also, we may transfer your data from the U.S. to other countries or regions in connection with storage and processing of data, fulfilling your requests, and operating the Services. By providing any information, including personal information, on or to the Services, you consent to such transfer, storage, and processing.
        </p>
        <h2>Update Your Information or Pose a Question</h2>
        <p>
          If you have questions about your privacy on Services or this privacy policy, please contact us at privacy@solvmate.co.
        </p>
        ...
        <p>
          ...
          top of this Privacy Policy and, in some cases, where appropriate, we
          may provide you with additional notice (such as adding a statement to
          our website's homepage or sending you an email notification). We
          encourage you to review our Privacy Policy whenever you use our
          Services to stay informed about our information practices and the ways
          you can help protect your privacy.
        </p>
        <h2>Contact Information</h2>
        <p>
          If you have any questions, comments, or concerns about our processing activities, please email us at privacy@solvmate.co.
        </p>
      </div>
    </div>
    <Footer />
